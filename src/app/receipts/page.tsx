...
export default function UserReceiptsPage() {
    ...
    const unsubscribe = onAuthStateChanged(auth, async (user) => {
      ...
      try {
        ...
        if (result.result === 'Success') {
          const userPayments = result.data.filter((p: PaymentRecord) =>
  ...
  if (loading) return <div className="p-6">Loading your receipts...</div>;

  return (
    <div className="p-6 overflow-x-auto">
      <div className="flex justify-between mb-4">
        <h1 className="text-xl font-bold">📄 My Payment Receipts</h1>
        {/* <LogoutButton /> */}
      </div>
